class RealProperty:
    ...
    def bigger(self, compared_to):
        is_bigger = True if self.square_metres > compared_to.square_metres else False
        return is_bigger
    ...
    def more_expensive(self, compared_to):
        diff = self.square_metres*self.price_per_sqm - compared_to.square_metres*compared_to.price_per_sqm
